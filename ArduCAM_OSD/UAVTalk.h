...
#define FLIGHTSTATUS_OBJID_007				0xE33E5D4E	// different ID for VERSION_RELEASE_15_05
...
#define GPSPOSITIONSENSOR_OBJID_002			0x98A7858C	// different ID for VERSION_RELEASE_15_05
